...
int main()
{
    ...
    for (ll testcase = 0; testcase < testcases; ++testcase)
    {
        ...
        if(m == 1){
            ...
            for (ll i = 0; i < n;i ++){
                if(a[i] == '0'){
                    // make a window of k length and skip those chars
                    i += k - 1;
                    cnt++;
                }
            }
        ...
        for (ll i = 0; i < n; i++)
        {
            // ignore 1st m - 1 0's consecutive sequence
            // if length exceeds that then make a use of power and make ans + 1
            // then skip the next k chars also and then again start by skipping the sequence of m - 1 0's
            if(a[i] == '0'){
                length++;
