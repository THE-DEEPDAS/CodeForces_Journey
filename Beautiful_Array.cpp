...
int main()
{
    ...
    {
        // mean aavu joiye a and median aavu joiye b
            // so x + y / 2 = means and ej median thay if we take 2 numbers so not possible
            // so we take 3 numbers and median will be middle number, now mare acerage joiye a 
            // so b - x + b + b + y = 3a
            // so y - x = 3(a - b)
            // let x = 5000(so 3*(a - b) can't make the thing negative) then y = 3(a - b) + 5000
            cout << 3 << "\n";
            cout << b - 5000 << " " << b << " " << b + 5000 + 3 * (a - b) << "\n";
    }
}
