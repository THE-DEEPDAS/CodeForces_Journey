...
int main()
{
    ...
    for (ll testcase = 0; testcase < testcases; testcase++)
    {
        ...
        // Query 1: single character "1"
        cout << "1 1" << endl;
        cout.flush();
        int ones = 0;
        cin >> ones;

        // Query 2: string of eleven "1"s
        cout << "1 11" << endl;
        cout.flush();
        int elevens = 0;
        cin >> elevens;

        // Query 3: string of ten "1"s
        cout << "1 10" << endl;
        cout.flush();
        int tens = 0;
        cin >> tens;

        // If the number of "1"s equals the sum of occurrences of "11" and "10",
        // then the last digit must be 0, otherwise it's 1
        if (ones == elevens + tens)
        {
            cout << "0 " << n << " 0" << endl;
        }
        else
